...
int main(int argc, char * argv[])
{
  ...
  // Add overlay
  // Draw text at bottom left or top left. i=0 is top.
  // Let's draw at bottom left.
  int text_y = height - 40;
  draw_text(rgb_image, width, height, "Among Us Gathering", 10, text_y, Eigen::Vector3d(1, 1, 1), 1);
  draw_text(rgb_image, width, height, "Jaehyeon Heo", 10, text_y + 10, Eigen::Vector3d(1, 1, 1), 1);
  draw_text(rgb_image, width, height, "CSC317 Fall 2025", 10, text_y + 20, Eigen::Vector3d(1, 1, 1), 1);
